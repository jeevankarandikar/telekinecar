...
def train_classifier(data_file="emg_gestures.pkl"):
    """
    Loads recorded data and trains a gesture classifier using two classes:
    clenched_fist and relaxed. Each epoch is filtered and then flattened into a
    feature vector. Performs 5‑fold cross‑validation on the training set and prints
    the CV scores.
    ...
    # Retain only the allowed gestures.
    allowed_gestures = ["clenched_fist", "relaxed"]
